...
class JobInsertSubdomains
{
    constructor()
    {
        this.key = 'JobInsertSubdomains';
        this.options = {
            attemps: 2,
            priority: 1
        };
    ...
    async handle(values)
    {
        ...
        const urlRequest = `${process.env.API_FOR_SEO}v3/dataforseo_labs/subdomains/live`;
...
export default new JobInsertSubdomains();
